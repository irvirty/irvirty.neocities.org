...
<a class="worldClick" style="top: calc(53% - (var(--worldClickHeight) / 2)); left: calc(17% - (var(--worldClickHeight) / 2));" target="blank" href="./p/black-hole" title="link"></a>
`;
printMyWorld(img, buttons);
break;
...
<a class="worldClick" style="top: calc(80% - (var(--worldClickHeight) / 2)); left: calc(40% - (var(--worldClickHeight) / 2));" target="blank" href="./p/curiosity/" title="link"></a>
`;
printMyWorld(img, buttons);
break;
