...
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?tag=${qPrint}">special</a>
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?sort_by=random&tag=${qPrint}">random</a>
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?sort_by=most_followed&tag=${qPrint}">followers</a>
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?sort_by=last_updated&tag=${qPrint}">update</a>
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?sort_by=views&tag=${qPrint}">views</a>
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?sort_by=tipping_enabled&tag=${qPrint}">tipping</a>
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?sort_by=newest&tag=${qPrint}">new</a>
<a class="tag light2 border3 borderRadius2 op" href="https://neocities.org/browse?sort_by=oldest&tag=${qPrint}">old</a>
</div>
</div>
